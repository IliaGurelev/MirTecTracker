<template>
  <div 
    class="login-page__switcher switcher"
    :class="{'switcher--left': isRegistration}"
  >
    <div class="switcher__content --center">
      ...
      <p v-if="!isRegistration" class="switcher__subtitle">
        Давайте подготовим вас ко всему, чтобы вы могли начать создавать свой первый опыт работы на платформе.
      </p>
