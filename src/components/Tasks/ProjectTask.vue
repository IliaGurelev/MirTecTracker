...
const columns = [
  {
    ...
    title: 'Открыт',
    list: 1,
    statuses: [{ text: 'Открыт', icon: 'fa-solid fa-circle-notch', class: 'open' }]
  },
  {
    globaltype: 'work',
    title: 'В работе',
    list: 2,
    statuses: [{ text: 'В работе', icon: 'fa-circle-play', class: 'inwork' }]
  },
  {
    globaltype: 'close',
    title: 'Закрыт',
    list: 3,
    statuses: [{ text: 'Закрыт', icon: 'fa-circle-check', class: 'close' }]
  }
]
