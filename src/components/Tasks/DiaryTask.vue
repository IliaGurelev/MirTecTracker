<template>
  <div class="diary-task" :class="{ 'diary-task--active': isActive}">
    ...
    <div class="task-content">
      ...
      <div class="task-wrapper">
        ...
        <button class="button-complite">
          <svg class="button-complite-icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.008 512.008" style="enable-background:new 0 0 512.008 512.008;" xml:space="preserve">
            <g>
              <g>
...
<style scoped>
  ...
  .button-complite>.button-complite-icon {
    width: 20px;
    fill: #ffffff;
  }

  .button-complite:hover {
    cursor: pointer;
