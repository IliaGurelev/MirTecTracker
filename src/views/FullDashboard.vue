    ...
    <section class="home-section">
      ...
      <div class="app">
        <main class="project">
          <div class="project-info">
            ...
            <div class="project-info__button">
              <AddTaskButton />
              <span class="button__invite_code" @click="openInviteModal"
            ...
            <InviteModal
              ...
              :inviteCode="currentDashboardInviteCode"
        ...
        <ProgressBars :items="filteredTasks" :sort="true">
          <WorkerList :workerList="userCurrentDashboard" />
        </ProgressBars>
      </div>
    </section>
  </body>
...
const { userCurrentDashboard, dashboards } = storeToRefs(dashboardStore)
...
watch(currentDashboard, () => {
  taskStore.fetchByDashboardTasks(currentDashboard.value.id)
  briefcaseStore.fetchBriefcase(currentDashboard.value.id)
})

onMounted(() => {
  taskStore.fetchByDashboardTasks(parseInt(router.currentRoute.value.query.id))
  briefcaseStore.fetchBriefcase(parseInt(router.currentRoute.value.query.id))
  workerStore.fetchWorkers()
  dashboardStore.fetchDashboards(currentUser.value.id)
  dashboardStore.fetchUsersByDashboard(parseInt(router.currentRoute.value.query.id))
})
</script>
